...
class Question(db.Model):
    ...
    """モードID"""
    updated_at: str = db.Column(db.DateTime, default=db.func.now(), onupdate=db.func.now())
    """更新日時"""
    created_at: str = db.Column(db.DateTime, default=db.func.now(), nullable=False)
    """作成日時"""
...
class RelatedWord(db.Model):
    ...
    """回答ID"""
    related_word: str = db.Column(db.String(255), nullable=False)
    """関連語"""
